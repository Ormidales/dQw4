			...
			<div class="w-full h-[92vh] overflow-hidden flex items-center">
				...
				<div class="w-4/5 h-[92vh] overflow-y-auto p-12">
					...
					<div class="w-full">
						...
						<p class="text-[30px] text-white font-bold">Badges</p>
					...
					<div class="w-full mt-12">
						...
						<div class="w-full">
							...
							<span class="px-3 py-1 border border-[#406BFF] bg-[#0135FF] text-white text-sm rounded-xl">Badge</span>

							<span class="ml-2 px-3 py-1 border border-[#97F461] bg-[#68ED2F] text-black text-sm rounded-xl">Badge</span>

							<span class="ml-2 px-3 py-1 border border-[#40EDFB] bg-[#02D4F9] text-white text-sm rounded-xl">Badge</span>

							<span class="ml-2 px-3 py-1 border border-[#FFE14B] bg-[#FFD30F] text-black text-sm rounded-xl">Badge</span>

							<span class="ml-2 px-3 py-1 border border-[#FA8D5E] bg-[#F7592A] text-black text-sm rounded-xl">Badge</span>

						</div>

						<div class="w-full mt-5">
							
							<pre><code class="language-html rounded">&lt;span class=&quot;px-3 py-1 border border-[#406BFF] bg-[#0135FF] text-white text-sm rounded-xl&quot;&gt;Badge&lt;/span&gt;
